# Project Brief - genericsuite superproject

## Project Overview

`genericsuite` is a superproject repository orchestrating the GenericSuite ecosystem - a comprehensive full-stack development framework designed to accelerate software development through AI-powered tools and unified frontend/backend libraries.

## Core Purpose

## Primary Goals

TODO: Add primary goals ...
...
### Out of Scope
TODO: Add out of scope ...

## Key Constraints

### Technical Constraints
- Must maintain compatibility with Python 3.12+ and Node.js 26+
